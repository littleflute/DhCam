...
#define PIN_SCALARCHANGED		(PIN_FIRST-10)
...
typedef struct {
	DWORD RangeMin;
	DWORD RangeMax;	//xupxTest 0522
	int LineSize; //added by HYL 2007.02.07
	// ...
}TRACKBARINFO;
...
#define WM_USER_PROP_SCALARPROPERTY   WM_USER+437
#endif // WM_USER_xxx
...
public:
   ...
   virtual BOOL SetRange(int nMin, int nMax)  = 0;
   ...
   virtual void SetCustomData(int value) = 0;
...
// Scalar property control notification structure
typedef struct tagNMPROPERTYSCALAR
{
   NMHDR hdr;
   HPROPERTY prop;
   int value;	
} NMPROPERTYSCALAR, *LPNMPROPERTYSCALAR;
