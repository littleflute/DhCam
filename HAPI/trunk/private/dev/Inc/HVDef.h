...
typedef enum tagHVTYPE{
	...
	DRVIF1394TYPE= 16384    //0x00004000
...
/*! \brief HV_MESSAGE_NOTIFY callback function parameter*/
typedef struct tagHV_MESSAGE_INFO{
	DWORD dwCode;
	char  *pBuffer;
	DWORD dwBuffSize;
}HV_MESSAGE_INFO;
...
typedef struct tagHV_PIO_OUTPUT_PORT_DESCRIPTOR{
	...
	struct {
		DWORD                       :27; ///< Reserved.
		DWORD StroboscopeInq        : 1; ///< Presence of Stroboscope Singnal,0:Not available 1:Available. 
...
typedef union tagHV_PIO_OUTPUT_PORT{
	...
	*/
	struct {
		DWORD Value : 5; ///< Select Signal Source. 
		                   //0:Integral 
		                   //1:trigger_ready 
		                   //2:User Set 
		                   //3:Strobe
...
typedef struct tagHV_RES_QUERY_ADV_FEATURE_PRESENCE{
	DWORD ImageInfoControl    : 1;///<Presence of IMAGE_INFO_CONTROL,0:Not available 1:Available.
	DWORD PixelsSeparateGainG1G2 : 1;///<Presence of Pixels Separate Gain RB,0:Not available 1:Available.
	DWORD PixelsSeparateGianRB   : 1;///<Presence of Pixels Separate Gain RB,0:Not available 1:Available.
	...
	DWORD PixelSeparateBlackLevelRB   : 1;
	DWORD PixelSeparateBlackLevelG1G2 : 1;
	DWORD                             :30;
...
typedef enum tagHV_ADV_FEATURE_ID{
	...
	ADV_FEATURE_ID_PIXEL_SEPARATE_GAIN_RB      = 29,
	ADV_FEATURE_ID_PIXEL_SEPARATE_GAIN_G1G2    = 30,
    ADV_FEATURE_ID_IMAGE_INFO_CONTROL          = 31,
	ADV_FEATURE_ID_PIXEL_SEPARATE_BLACK_LEVEL_RB   = 32,
	ADV_FEATURE_ID_PIXEL_SEPARATE_BLACK_LEVEL_G1G2 = 33
...
typedef union tagHV_ADV_FEATURE_DESCRIPTOR{
	...
	ADV_FEATURE_ID_PIXELS_SEPARATE_GAIN_RB
	ADV_FEATURE_ID_PIXELS_SEPARATE_GAIN_G1G2
	ADV_FEATURE_ID_PIXEL_SEPARATE_BLACK_LEVEL_RB
	ADV_FEATURE_ID_PIXEL_SEPARATE_BLACK_LEVEL_G1G2
	*/
	struct {
		DWORD MaxValue       :12; ///< Maximum value
		DWORD MinValue       :12; ///< Minimum value
...
typedef union tagHV_ADV_FEATURE{
	...
	*/
	...
	/*!
	PixelSeparate field for the functions:
	ADV_FEATURE_ID_PIXEL_SEPARATE_GAIN_RB
	ADV_FEATURE_ID_PIXEL_SEPARATE_GAIN_G1G2
	ADV_FEATURE_ID_PIXEL_SEPARATE_BLACK_LEVEL_RB
	ADV_FEATURE_ID_PIXEL_SEPARATE_BLACK_LEVEL_G1G2
	*/
	struct {
		DWORD B_G2_Value     :12; ///< R or G2 value
		DWORD R_G1_Value     :12; ///< B or G1 Value
		DWORD AutoManualMode : 1; ///< Reserved
		DWORD OnOff          : 1; ///< Switch to turn this feature ON or OFF, 0:OFF 1:ON.
		DWORD OnePush        : 1; ///< Reserved
        DWORD                : 3; 
...
typedef enum tagHV_ADV_FEATURE_ITEM_ID{
	...
	ADV_FEATURE_ITEM_ID_PIXEL_SEPARATE_PRESENCE_INQ    = 0x0F0000,
	ADV_FEATURE_ITEM_ID_PIXEL_SEPARATE_ABS_CONTROL     = 0x0F0001,
	ADV_FEATURE_ITEM_ID_PIXEL_SEPARATE_ONE_PUSH        = 0x0F0005,
	ADV_FEATURE_ITEM_ID_PIXEL_SEPARATE_ON_OFF          = 0x0F0006,
	ADV_FEATURE_ITEM_ID_PIXEL_SEPARATE_AUTO_MANUAL_MODE_VALUE = 0x0F0007,
	ADV_FEATURE_ITEM_ID_PIXEL_SEPARATE_R_G1_VALUE      = 0x0F0008,
	ADV_FEATURE_ITEM_ID_PIXEL_SEPARATE_B_G2_VALUE      = 0x0F0014,
...
typedef struct tagHV_RES_QUERY_IMAGE_INFO_PRESENCE{
	DWORD                          : 24;
	DWORD GreySum                  : 1;
	DWORD AsynResetCaptureCount    : 1;///< Presence of Async Reset Capture Count,0:Not available 1:Available.
	DWORD TransImageCount          : 1;///< Presence of Trans Image Count,0:Not available 1:Available.
...
typedef enum tagHV_IMAGE_INFO_ID{
    ...
    IMAGE_INFO_ID_TRANS_IIMAGE_COUNT  = 5,
    IMAGE_INFO_ID_ASYNRESET_CAPTURE_COUNT = 6,
	IMAGE_INFO_ID_GREY_SUM  = 7,				
}HV_IMAGE_INFO_ID;
