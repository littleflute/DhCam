...
public:
    ...
    union
    {
        struct
        {
            ...
            UINT m_TriggerValue     : 1;  // Trigger input raw signal value. Read only. 0:Low, 1:High.
            UINT m_TriggerSource    : 3;  // Select trigger source. Set trigger source ID from trigger source ID_Inq.
